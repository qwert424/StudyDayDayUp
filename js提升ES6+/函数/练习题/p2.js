...
// 得到所有电话号码以1结尾的学生
// const filter = students.filter((stu) => stu.tel.endsWith('1'))
// console.log(filter)

// 得到所有学生姓名组成的数组
// const arr = students.map((stu) => stu.name)
// console.log(arr)

// 得到所有女生的姓名和电话号码 [ {name:'monica', tel:'18122223333'} ]
// const girlarr = students.filter(x => x.sex = "女").map(x => { return { name: x.name, tel: x.tel } })
// console.log(girlarr)

// 将每个学生变为一个 li 元素字符串，元素内容为学生姓名，拼接所有元素，形成一个长字符串 <li>张三</li><li>李四</li>...
// const obj = students.map(stu => `<li>${stu.name}</li>`).join('');
// console.log(obj)
// console.log(...obj)